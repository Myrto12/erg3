...
void start(void);
void importText(char text[WORDS][MAXCHARS+1], char customTextName[100]);
void importDictionary(char dictionary[WORDS][MAXCHARS+1], char customDictName[100]);
void editMode(char text[WORDS][MAXCHARS+1], char dictionary[WORDS][MAXCHARS+1], char customDictName[100]);
    ...
    do{
        switch (selectOperation()){
            ...
            case 0:
                ...
                break;
            case 1:
                importText(text, customTextName);
                break;
            case 2:
                importDictionary(dictionary, customDictName);
                break;
            case 3:
                editMode(text, dictionary, customDictName);
                break;
            case 4:
                computeStats(text);
                break;
...
void importText(char text[WORDS][MAXCHARS+1], char customTextName[100]){
    ...
    if (customTextName[0]=='\0'){strcpy(textFile, defaultTextName);}
    else {strcpy(textFile, customTextName);}
...
void importDictionary(char dictionary[WORDS][MAXCHARS+1], char customDictName[100]){
    FILE *file;
    char word[MAXCHARS+1], dictionaryName[100];
    int i=0;
